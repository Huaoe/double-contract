...
export interface VipDoNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwner"
      | "admin"
...
export interface VipDoNFT extends BaseContract {
  connect(runner?: ContractRunner | null): VipDoNFT;
  waitForDeployment(): Promise<this>;

  interface: VipDoNFTInterface;
