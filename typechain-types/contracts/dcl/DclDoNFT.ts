...
export interface DclDoNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwner"
      | "admin"
...
export interface DclDoNFT extends BaseContract {
  connect(runner?: ContractRunner | null): DclDoNFT;
  waitForDeployment(): Promise<this>;

  interface: DclDoNFTInterface;
