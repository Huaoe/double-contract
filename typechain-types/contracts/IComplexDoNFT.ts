...
export interface IComplexDoNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "checkIn"
      | "claimRoyaltyAdmin"
...
export interface IComplexDoNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IComplexDoNFT;
  waitForDeployment(): Promise<this>;

  interface: IComplexDoNFTInterface;
