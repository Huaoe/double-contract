...
export interface CheckInMgrInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwner"
      | "admin"
...
export interface CheckInMgr extends BaseContract {
  connect(runner?: ContractRunner | null): CheckInMgr;
  waitForDeployment(): Promise<this>;

  interface: CheckInMgrInterface;
