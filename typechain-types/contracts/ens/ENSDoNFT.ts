...
export interface ENSDoNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwner"
      | "admin"
  ...
  encodeFunctionData(
    functionFragment: "isCheckInDataExpired",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "resetExpiredTo",
...
export interface ENSDoNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ENSDoNFT;
  waitForDeployment(): Promise<this>;

  interface: ENSDoNFTInterface;
  ...
  initializeENS: TypedContractMethod<
    [
      name_: string,
      symbol_: string,
      nftAddress_: AddressLike,
  ...
  isCheckInDataExpired: TypedContractMethod<
    [oid: BigNumberish],
    [boolean],
    "view"
  >;
  ...
  resetExpiredTo: TypedContractMethod<
    [ids: BigNumberish[], to: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "isCheckInDataExpired"
  ): TypedContractMethod<[oid: BigNumberish], [boolean], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "resetExpiredTo"
  ): TypedContractMethod<
    [ids: BigNumberish[], to: AddressLike],
    [void],
    "nonpayable"
