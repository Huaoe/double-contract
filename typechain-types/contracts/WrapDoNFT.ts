...
export interface WrapDoNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwner"
      | "admin"
...
export interface WrapDoNFT extends BaseContract {
  connect(runner?: ContractRunner | null): WrapDoNFT;
  waitForDeployment(): Promise<this>;

  interface: WrapDoNFTInterface;
